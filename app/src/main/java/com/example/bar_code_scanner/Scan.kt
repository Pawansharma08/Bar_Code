...
class Scan : AppCompatActivity() {
    ...
    private fun shareQRCodeLink(qrCodeLink: String) {
        val sharingIntent = Intent(Intent.ACTION_SEND)
        sharingIntent.type = "text/plain"
        sharingIntent.putExtra(Intent.EXTRA_TEXT, qrCodeLink)
        startActivity(Intent.createChooser(sharingIntent, "Share QR Code Link"))
    }
}
